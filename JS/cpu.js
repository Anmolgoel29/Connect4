...
let pos=1;
document.querySelector(`.pointer div:nth-child(${pos})`).style=`background: url("/Image/png-transparent-computer-mouse-pointer-computer-keyboard-cursor-computer-mouse-love-electronics-hand-thumbnail.png");background-size: cover;`
